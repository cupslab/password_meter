...
export module Helper {
    ...
    export class Helper {
        ...
        compressedFileToBloomFilter(path: string, blacklistSubstringLength: number) {
            ...
            var bloomer = new BloomFilter.BloomFilter(bloomBitsPerElement, bloomEstimatedNumElements);
            var wordsAdded = 0;
