...
export module UIMisc {
    ...
    export class UIMisc {
        ...
        displayBar(score: number, metRequirements: boolean, pw: string): void {
            ...
            this.$("#cups-passwordmeter-span").css("background-color", barcolor).trigger("change", [score.toString(), heuristicScore, nnNumScore, heuristicLogGuessNum, conservativeNnLogGuessNum]);
